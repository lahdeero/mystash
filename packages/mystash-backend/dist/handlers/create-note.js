    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                title = parsedBody.title, content = parsedBody.content, tags = parsedBody.tags, createdAt = parsedBody.createdAt, updatedAt = parsedBody.updatedAt;
                item = {
                    id: (0, uuid_1.v4)(),
                    title: title,
                    content: content,
...
exports.handler = (0, jwt_1.jwtMiddleware)(createNoteHandler, process.env.SECRET);
